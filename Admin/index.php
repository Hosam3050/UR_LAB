...
<body>
  <header>
    <nav>
      ...
      <div>
        <ul>
          <a href="http://localhost/UR_LAB/Auth/login.php">
            <button>
              <span>دخول</span>
            </button>
          </a>
          <a href="http://localhost/UR_LAB/Auth/register_lab.php">
            <button>
              <span>تسجيل الدخول للمعمل</span>
            </button>
          </a>
          <a href="http://localhost/UR_LAB/Auth/register_patient.php">
            <button>
              <span>تسجيل الدخول كمستخدم</span>
            </button>
          </a>
  ...
  <section class="body">
  <iframe src='https://my.spline.design/untitled-181e978c3e5a70f1fdc0743fe959b947/' frameborder='0' width='100%' height='100%'></iframe>
    <!-- <div class="card">
      <div class="radio-inputs">
      <div>
        <input class="input" placeholder=" اختر المنطقة من محافظة أسوان" list="input">
        <datalist id="input">
          <option value="أسوان"></option>
          <option value="دراو"></option>
          <option value="كوم أمبو"></option>
          <option value="نصر النوبة"></option>
          <option value="ادفو"></option>
        </datalist>
  ...
  <section class="who_are">
    <div>
      <img data-aos="fade-left" src="../images/fa35c5127987492.Y3JvcCwxMzAwLDEwMTYsMCwxNDE.jpg" width="300px" alt="">
    </div>
  ...
  <section class="photos">
    ...
    <section class="photos">
      <div class="images">
        ...
        <img data-aos="fade-up-left" src="../images/تحليل-سعة-توزيع-كريات-الدم-الحمراء-rdw.jpg" alt="">
        <img data-aos="fade-up-right" src="../images/WhatsApp Image 2023.jpg" alt="">
      </div>
    </section>
    ...
    <footer data-aos="fade-up" data-aos="zoom-in" class="text-center text-lg-start bg-light text-muted">
      ...
      <section style="background-color:#046998;" class="d-flex justify-content-center justify-content-lg-between p-4 border-bottom">
        ...
        <div class="me-5 d-none d-lg-block">
          <span style="color: #ffffff;">تواصل معنا على شبكات التواصل الاجتماعي</span>
        </div>
        <!-- Right -->
        <div>
        ...
        <div class="container text-center text-md-start mt-5">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
              ...
              <p><i class="fas fa-phone me-3"></i> + 20 124 567 888</p>
              <p><i class="fas fa-print me-3"></i> + 20 113 567 559</p>
            </div>
            <!-- Grid column -->
          </div>
          <!-- Grid row -->
