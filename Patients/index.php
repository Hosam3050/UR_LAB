...
<body>
  <header>
    <nav>
      <div class="logo">
      <img width="60px" data-aos="fade-left" src="../images/logo.png" width="300px" ; alt="">
      </div>
      <div>
        <ul>
          ...
          <a style="color:#ffffff" href="profile.php">
    ...
    <div class="card">
      <div class="radio-inputs">
        <label class="radio">
          ...
          <span class="name">الأشعة</span>
        </label>
        <label class="radio">
          <input type="radio" name="radio">
          <span class="name">تحاليل طبية</span>
        </label>
      </div>
      ...
      <div>
        ...
        <button class="search_button">
          <span><a style="text-decoration:none;" href="Labs.php">عرض المعامل </a></span>
        </button>
      </div>
    </div>
  </section>
